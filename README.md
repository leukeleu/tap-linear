...
```bash
pipx install git+https://github.com/ORG_NAME/tap-linear.git@main
```
...
| api_url             | False    | https://api.linear.app/graphql | The URL for the API service |
...
A full list of supported settings and capabilities is available by running: `tap-linear --about`
